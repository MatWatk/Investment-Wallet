    ...
    return (
        <>
            <div className={tablestyles.tableHeader}>
                ...
                {props.last24hChange && <p className="w-18 text-xs text-center shrink-0">Last 24h change</p>}
                {props.last30dChange && <p className="w-18 text-xs text-center shrink-0">Last 30d change</p>}
